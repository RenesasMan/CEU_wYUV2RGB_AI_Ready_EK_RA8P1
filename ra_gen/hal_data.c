...
ceu_instance_ctrl_t g_ceu_sxga_ctrl;
const ceu_extended_cfg_t g_ceu_sxga_extended_cfg =
{ .capture_format = CEU_CAPTURE_FORMAT_DATA_SYNCHRONOUS,
  .input_order = CEU_INPUT_ORDER_CB0Y0CR0Y1,
  .output_format = CEU_OUTPUT_FORMAT_YCBCR422,
  .data_bus_width = CEU_DATA_BUS_SIZE_8_BIT,
  ...
  .h_output_size = 0,
  .v_output_size = 0,
  .image_area_size = 1280 * 960 * 2,
  .interrupts_enabled = 0 | R_CEU_CEIER_CPEIE_Msk | 0 | R_CEU_CEIER_VDIE_Msk | R_CEU_CEIER_CDTOFIE_Msk | 0 | 0
          | R_CEU_CEIER_VBPIE_Msk | R_CEU_CEIER_NHDIE_Msk | R_CEU_CEIER_NVDIE_Msk,
  .ceu_ipl = (12),
  .ceu_irq = VECTOR_NUMBER_CEU_CEUI, };

const capture_cfg_t g_ceu_sxga_cfg =
{ .x_capture_pixels = 1280,
  .y_capture_pixels = 960,
  .x_capture_start_pixel = 0,
  .y_capture_start_pixel = 0,
  .bytes_per_pixel = 2,
  .p_callback = g_ceu_sxga_callback,
  .p_context = (void*) NULL,
  .p_extend = &g_ceu_sxga_extended_cfg, };

const capture_instance_t g_ceu_sxga =
{ .p_ctrl = &g_ceu_sxga_ctrl, .p_cfg = &g_ceu_sxga_cfg, .p_api = &g_ceu_on_capture, };
...
/* Actual period: 4e-8 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0xc,
  .duty_cycle_counts = 0x6, .source_div = (timer_source_div_t) 0, .channel = 12, .p_callback = NULL,
...
iic_master_instance_ctrl_t g_i2c_master_for_cam_ctrl;
const iic_master_extended_cfg_t g_i2c_master_for_cam_extend =
...
const i2c_master_cfg_t g_i2c_master_for_cam_cfg =
{ .channel = 1, .rate = I2C_MASTER_RATE_FAST, .slave = 0x3C, .addr_mode = I2C_MASTER_ADDR_MODE_7BIT,
...
#undef RA_NOT_DEFINED
  .p_callback = g_i2c_master_for_cam_callback,
  .p_context = NULL,
...
#endif
  .ipl = (12),
  .p_extend = &g_i2c_master_for_cam_extend, };
/* Instance structure to use this module. */
const i2c_master_instance_t g_i2c_master_for_cam =
{ .p_ctrl = &g_i2c_master_for_cam_ctrl, .p_cfg = &g_i2c_master_for_cam_cfg, .p_api = &g_i2c_master_on_iic };
